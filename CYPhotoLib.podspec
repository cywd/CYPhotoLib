#
#  Be sure to run `pod spec lint CYPhotoLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Cyrill"
  # s.authors            = { "Cyrill" => "lichunyang@outlook.com" }
  # s.social_media_url   = "http://twitter.com/Cyrill"
  ...
  s.source_files  = "CYPhotoLib/Classes/**/*.{h,m}", "CYPhotoLib/Classes/*.{h,m}"
